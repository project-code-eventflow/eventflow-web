...
const MobileApp: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} id="mobile" className="py-24 bg-slate-900 text-white overflow-hidden relative">
      {/* Background Decor */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="reveal">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-slate-800 border border-slate-700 text-primary-400 text-sm font-semibold mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="flex items-center justify-center gap-3 px-6 py-3.5 bg-white text-slate-900 rounded-xl hover:bg-slate-100 transition-all font-semibold">
              ...
              <button className="flex items-center justify-center gap-3 px-6 py-3.5 bg-slate-800 border border-slate-700 text-white rounded-xl hover:bg-slate-700 transition-all font-semibold">
